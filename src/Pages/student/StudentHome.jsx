...
function StudentHome() {
  ...
  const admitCardPath = `/student/admit-card?studentId=${encodeURIComponent(studentId)}`
  return <main className="portal-main home-page">
    ...
    <div className="action-grid">
      <button className="action-card learn" onClick={() => navigate(admitCardPath)}><strong>▣&nbsp; Learn/Revise</strong><span>Click here if you want to learn something new, or revise something that you have already learned</span></button>
