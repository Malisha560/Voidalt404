...
function Attendance() {
  ...
  useEffect(() => { fetchInvigilatorAttendance().then((data) => { setRecords(data); setExamination(String(data[0]?.examId || '')) }).catch(() => setError('Unable to load attendance records.')).finally(() => setLoading(false)) }, [])
